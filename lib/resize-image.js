var moveImage = require('./move-image')
  ...
  , resizeImage = function (image, changeFactor, width, height) {
      var widthChange = image.width * changeFactor - image.width
        , heightChange = image.height * changeFactor - image.height
